...
export interface SortFunctionMapping {
  orderBySortOrder: (Products: Product[]) => Product[];
  orderByReleaseDate: (Products: Product[]) => Product[];
  orderByPromotion: (Products: Product[]) => Product[];
}
